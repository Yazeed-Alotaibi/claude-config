...
These constraints are not obvious from public examples and have caused repeated installation failures in the past. They are documented in detail in `PLUGIN_SCHEMA_NOTES.md` (at the root of this repo; `.claude-plugin/PLUGIN_SCHEMA_NOTES.md` in a packaged plugin), which should be reviewed before making any changes to the plugin manifest.
